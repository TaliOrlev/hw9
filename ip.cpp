...
bool Ip::set_value(String val) {
	...
	/* if the mask is 0, meaning all ips are allowed */
	...
	/* covert the ip to int by shifting every part in the matching factor */
	...
	/* if the mask is 32, there is no range, only one value is valid */
	...
	/* keep the relevent bits from ip by shifting left and then right */
